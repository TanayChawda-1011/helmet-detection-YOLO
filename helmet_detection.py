...
modelWeights = "D:\Degree\Degree 5th sem\Project\yolov3-obj_2400.weights";
...
# output_layer = [layersNames[i] for i in net.getUnconnectedOutLayers()]
output_layer = [layersNames[net.getUnconnectedOutLayers()[0] - 1]]
